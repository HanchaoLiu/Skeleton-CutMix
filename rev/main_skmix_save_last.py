...
class Processor():
    ...
    def start(self):
        ...
        if self.arg.phase == 'train':
            ...
            last_model_string = 'model_ep{}.pt'.format(self.arg.num_epoch-1)
            model_name_to_remove = [kk for kk in model_name_to_remove if os.path.basename(kk)!=last_model_string]
