...
# sh rev/common23_new_pis_e2n.sh 1 2
...
for seed in 0; do
    for idx in 0; do
        ...
        python rev/main_skmix_aug.py \
            ...
            --train-feeder-args "dataset='e2n',T=${T},theta=${theta},p1=${p},p2=${p},method='${method}',choose_from='${choose_from}',use_mmap=0" --use-aug ${use_aug}  \
            --weight_aug 0.8 \
