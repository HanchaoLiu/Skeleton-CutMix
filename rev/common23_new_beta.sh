...
# sh rev/common23_new_beta.sh 2 0
# sh rev/common23_new_beta.sh 3 1
device=$1
config_idx=$2
seed_list=(0)
...
for seed in 0; do
    for idx in 0; do
        ...
        work_dir="z2025_${model_name}_${config}_seed${seed}_useAug${use_aug}_${method}_${choose_from}_ep${num_epoch}_v${idx}_p${p}_theta${theta}_weightdst${weight_dst}aug"
...
echo "this is L_src+L_dst*w_dst+L_aug*w_aug, weight_dst=${weight_dst}"